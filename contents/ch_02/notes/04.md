...
* Props.)
  ...
  * C99 supports long double data type.
    ...
    * Although *long double* data type requires 10 bytes, GCC allocates 12 bytes.
      * Check [Practice Problem 3.35](https://github.com/JoonHyeok-hozy-Kim/computer_systems_study/blob/main/contents/ch_03/problems/practice.md#practice-problem-335)]
