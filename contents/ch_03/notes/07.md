...
1. Save Return Address at (%esp) and "subl $4, %esp"
2. Save old %ebp at (%esp) and "subl $4, %esp"
...
![](https://github.com/JoonHyeok-hozy-Kim/computer_systems_study/blob/main/contents/ch_03/images/03_06_04_simulation.png)
...
* In assembly
  ```assembly
    pushl   %ebp            Save old %ebp on stack.
