...
* ex2.) **setb** (Only for unsigned!)
  * "a < b" <==> "a-b < 0" <==> "t < 0"
  * Consider the following cases that satisfies "**a < b**"
    * Since a and b are unsigned numbers, if a is below b, then there will be CARRY!
