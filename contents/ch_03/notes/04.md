...
[:orange_book: Practice Problem 3.1](https://github.com/JoonHyeok-hozy-Kim/computer_systems_study/blob/main/contents/ch_03/problems/practice_problems.md#practice-problem-254)
...
<p align="left">
  <img src="https://github.com/JoonHyeok-hozy-Kim/computer_systems_study/blob/main/contents/ch_03/images/03_04_02_data_movement_instructions_ex.png" width="60%">
</p>
<br>
...
* Prop.) Equivalent Operations
  * Push operation is consisted with two operations
    1. Decrementing stack pointer
      * why?) The data type of the source value may vary : 1, 2, 4 byte.
    2. Moving value
